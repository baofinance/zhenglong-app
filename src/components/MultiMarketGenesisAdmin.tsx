...
export function MultiMarketGenesisAdmin() {
      ...
      <div className="min-h-screen bg-black text-white">
        <div className="max-w-6xl mx-auto p-6">
          <div className="text-center">
            <h1
              className={`text-3xl font-bold mb-4 text-[#4A7C59] ${geo.className}`}
            >
              Multi-Market Genesis Admin
            </h1>
            <p className="text-[#F5F5F5]/60">Loading market data...</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="max-w-6xl mx-auto p-6">
        <h1
          className={`text-3xl font-bold mb-8 text-[#4A7C59] ${geo.className}`}
        >
          Multi-Market Genesis Admin
        </h1>
        ...
        <div className="bg-[#1A1A1A]/95 p-6 shadow-[0_0_15px_rgba(74,124,89,0.1)] mb-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="text-center p-4 bg-[#202020] rounded-lg">
              ...
              <div className="text-sm text-[#F5F5F5]/70">Total Collateral</div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          {displayedMarkets.length === 0 ? (
            <div className="text-center py-12 text-[#F5F5F5]/50">
              <p>
